...
const template = require("./guest-item-embed.component.html");
const styles = require("./guest-item-embed.component.scss");

export class GuestItemEmbedComponent extends HTMLElement {
    constructor() {
        super();
    ...
    private async _onDeleteClick(e:Event) {
        this.dispatchEvent(new GuestDelete(this.entity)); 
    }

    private _onEditClick() {
        this.dispatchEvent(new GuestEdit(this.entity));
    }
...
customElements.define(`ce-guest-item-embed`,GuestItemEmbedComponent);
