...
const template = require("./product-item-embed.component.html");
const styles = require("./product-item-embed.component.scss");

export class ProductItemEmbedComponent extends HTMLElement {
    constructor() {
        super();
    ...
    private async _onDeleteClick(e:Event) {
        this.dispatchEvent(new ProductDelete(this.entity)); 
    }

    private _onEditClick() {
        this.dispatchEvent(new ProductEdit(this.entity));
    }
...
customElements.define(`ce-product-item-embed`,ProductItemEmbedComponent);
