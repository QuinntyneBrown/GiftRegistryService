...
const template = require("./event-item-embed.component.html");
const styles = require("./event-item-embed.component.scss");

export class EventItemEmbedComponent extends HTMLElement {
    constructor() {
        super();
    ...
    private async _onDeleteClick(e) {
        this.dispatchEvent(new EventDelete(this.entity)); 
    }

    private _onEditClick() {
        this.dispatchEvent(new EventEdit(this.entity));
    }
...
customElements.define(`ce-event-item-embed`,EventItemEmbedComponent);
