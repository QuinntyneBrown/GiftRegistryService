...
using static GiftRegistryService.Features.Accounts.AddOrUpdateAccountCommand;
using static GiftRegistryService.Features.Accounts.GetAccountsQuery;
using static GiftRegistryService.Features.Accounts.GetAccountByIdQuery;
using static GiftRegistryService.Features.Accounts.RemoveAccountCommand;
