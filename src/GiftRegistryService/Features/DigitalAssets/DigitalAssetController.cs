using GiftRegistryService.Features.DigitalAssets.UploadHandlers;
...
using static GiftRegistryService.Features.DigitalAssets.GetDigitalAssetByUniqueIdQuery;
using static GiftRegistryService.Features.DigitalAssets.AzureBlobStorageDigitalAssetCommand;
