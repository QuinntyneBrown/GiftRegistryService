...
using static GiftRegistryService.Features.Tenants.AddOrUpdateTenantCommand;
using static GiftRegistryService.Features.Tenants.GetTenantsQuery;
using static GiftRegistryService.Features.Tenants.GetTenantByIdQuery;
using static GiftRegistryService.Features.Tenants.RemoveTenantCommand;
